...
urlpatterns = [
    ...
    path('remote/<path:url>/accept', view=accept_remote_follow_request, name='accept_remote_request'),
    path('remote/<path:url>/reject', view=reject_remote_follow_request, name='reject_remote_request'),
